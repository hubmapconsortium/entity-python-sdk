...
class TestProvInfo:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_retrieve_with_all_params(self, client: HubmapEntitySDK) -> None:
        prov_info = client.datasets.prov_info.retrieve(
            id="id",
            format="json",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_list_all_with_all_params(self, client: HubmapEntitySDK) -> None:
        prov_info = client.datasets.prov_info.list_all(
            dataset_status="qa",
            format="json",
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_list_all(self, client: HubmapEntitySDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_list_all(self, client: HubmapEntitySDK) -> None:
...
class TestAsyncProvInfo:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_retrieve_with_all_params(self, async_client: AsyncHubmapEntitySDK) -> None:
        prov_info = await async_client.datasets.prov_info.retrieve(
            id="id",
            format="json",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_list_all_with_all_params(self, async_client: AsyncHubmapEntitySDK) -> None:
        prov_info = await async_client.datasets.prov_info.list_all(
            dataset_status="qa",
            format="json",
            group_uuid="group_uuid",
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_list_all(self, async_client: AsyncHubmapEntitySDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_list_all(self, async_client: AsyncHubmapEntitySDK) -> None:
